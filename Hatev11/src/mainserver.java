...
/**
 * Title:        mainserver
 * Description:  This is the mainserver for the telnet MUD
...
if(confront == 1 ){
 ...
 foundmonster.monstertask(userid, sqlstuff.monsterid, sqlstuff.monstername);
 confront=0;
}
...
/////
	...
	String field;
           ...
           System.out.println(posx+" CC "+posy);
           	String fieldname="";
           	if(field.equals("F"))fieldname="Forrest";
           	if(field.equals("W"))fieldname="Sea";
           	if(field.equals("D"))fieldname="Dessert";
           	if(field.equals("H"))fieldname="Hell";
        	if(field.equals("S"))fieldname="Snow landscape";
...
/////
   ...
   int min=posx-10;if(min<0)min=0;if(min>100)min=100;
   int max=posy-10;if(max<0)max=0;if(max>100)max=100;
   int minx=posx+10;if(minx<0)minx=0;if(minx>100)minx=100;
   int maxx=posy+10;if(maxx<0)maxx=0;if(maxx>100)maxx=100;
